    ...
    return (
        <>
            <div className="flex items-center justify-center h-screen bg-gray-200">
                ...
                <div className="absolute top-[0px] letf-[0px] w-[644px] h-[151px] opacity-100 bg-[#3EEE9A]">
                    <div>
                        <Image                                
                            src= "/perfil.png"
                            alt= "Foto de perfil"
                    ...
                    <BotaoVoltar />
                    <button className="absolute top-[160px] left-[450px] px-[15px] py-[5px] bg-customGreen text-black font-inter rounded-lg border-[1px] border-black shadow-md hover:bg-[#3EEE9A] focus:outline-none focus:ring-2 focus:ring-black focus:ring-opacity-75">
                        Editar Perfil
                    </button>
